...
## Latest Version: Version 1.6.0.b "Alhambra" (Released 6/4/22, for vanilla patch 1.6.x)
...
### Version 1.6.0.b Hotfix

### Version 1.6.0.a Hotfix

- RICE+EPE compatch updated to the new patch
- Added decision to rededicate the temple of Luxor to be a pagan temple or Christian Church
- Group vacations at a Munya now give slight stress relief
- Teimani and Parsim cultures start with Qanat innovation
- New Jewish cultures added in 1.6.0 can now appear in events from previous RICE updates as appropriate
- Amazigh faith now has Chthonic Redoubts and female clerical gender to be in line with BAP mod
- Fixed missing custom faith icons for new religions in RICE
- Fixed AI not taking Reopen/Close Aswan Temple decisions due to low gold
