...
- Added Nudists tradition and Papuan fashion to Vedda culture
- Added small Sukhavati (Pure Land) presence in Vietnam in all start dates
- Tweaked ethnicity values/percentages in new cultures to be in line with vanilla's changes in 1.18.2
- Added Petros (Petrou), Bishop of Kourte in the c. 11th or 12th centuries, as a courtier in Nobatia in 1066
- Added Eikkir, a 11th or 12th century Nubian noblewoman and church patron, as a courtier in Makuria in 1066
- Added missing icon for the Tropical Goods interactions in SE Asia
- Assigned the county of Heihe to Cao Yijin in 867 so he starts off with some land
- Wamo rulers have returned to the Gansu region
- Goryeo culture now has Warrior Monks tradition instead of Court Eunuchs
- Nile Pastoralist and Farmer decisions now require owning land, so Adventurers can no longer take it
- Wamo culture now uses Bodpa namelist
- Merchants generated from trade caravan travel options are now always randomly generated and will usually be removed from the game after the journey is over, it was too much a hassle to account for edge cases otherwise
- Merchants generated from trade caravan travel options will now start with a modifier reducing their fertility to prevent AI from marrying off to others during their travels
- Removed RICE’s duplicate Yan Yingda
- Moved some game start effects into a new RICE_setup_general_east_asian_flavor_effect scripted effect
- Vedda now also has Papuan ethnicity
- Decreased the amount of Semang courtiers randomly spawned at game start
- Fixed Poetry Gathering activity almost always guaranteeing you a poem artifact
- Fixed the culture of Geoffrey Burel (in 1066) and Stephen of Jerusalem (in 1178) being Frankish rather than French
- Fixed some references to Frankish instead of French culture in the code
- Fixed missing placeholder loc for some bookmark text in a few non-English languages
- Fixed missing localization for Javanese, Sunda, Batak, and Bugis dynasty names
- Fixed Malagasy being a hybrid of Dayak and the non-existent Sabaki instead of Dayak and East Bantu (relocalized as Sabaki in RICE) in the RICE+EPE Compatch
- Fixed Lu You’s son not being set as his son correctly
- Fixed missing death and witch deity names for some Malayic pagan faiths
- Fixed Cao Yijin using a pre-AUH bookmark portrait for the 867 bookmark
- Fixed some Dunhuang characters still being Mahayana rather than Chinese Buddhist
